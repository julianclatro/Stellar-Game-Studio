...
import { ZkSeekGame } from './games/zk-seek/ZkSeekGame';

const GAME_ID = 'zk-seek';
const GAME_TITLE = import.meta.env.VITE_GAME_TITLE || 'Zk Seek';
      ...
      {!hasContract ? (
        <div className="card">
          ...
          <p style={{ color: 'var(--color-ink-muted)', marginTop: '1rem' }}>
            ...
            <code>VITE_ZK_SEEK_CONTRACT_ID</code> in the root <code>.env</code>.
          </p>
        </div>
      ) : !devReady ? (
        <div className="card">
